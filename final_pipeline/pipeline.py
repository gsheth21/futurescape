...
SRC_DIR = Path('../superpoint/src')

BOARD_YOLO_WEIGHTS  = '/mnt/e/NCSU/Fall_2025/Board Game/superpoint/src/saved_models/board_detector_v1.pt'
PIECE_YOLO_WEIGHTS  = '/mnt/e/NCSU/Fall_2025/Board Game/piece_detection/red_piece_detection/saved_models/red_piece_detector.pt'
SP_WEIGHTS          = str(SRC_DIR / '../SuperPointPretrainedNetwork/pretrained/superpoint_v1.pth')
TEMPLATE_DIR        = SRC_DIR / '../raw_dataset/preprocessed/cropped_ideal_templates'
TEMPLATE_IMAGE      = TEMPLATE_DIR / 'cropped_ideal_image.png'
TEMPLATE_KPS_PATH   = TEMPLATE_DIR / 'cropped_ideal_image_gt.npy'
HEX_CENTERS_PATH    = TEMPLATE_DIR / 'cropped_ideal_image_hex_centers.json'

BOARD_CONF   = 0.5
PIECE_CONF   = 0.5
BOARD_PAD    = 0.05   # 5% padding around detected board bbox
