"""
Script: Compute homography between ideal template and test image(s),
and visualize:
...
Usage:
    Single image:
        python compute_homography.py --template_dir <path> --test_image <path_to_crop.png> --output_dir <path>
    All images in directory:
        python compute_homography.py --template_dir <path> --test_dir <path> --output_dir <path>
"""
