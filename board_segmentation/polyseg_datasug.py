...
DATASET_DIR = "board_segmentation_dataset"
IMG_DIR = os.path.join(DATASET_DIR, "images")  # Original images
LBL_DIR = os.path.join(DATASET_DIR, "labels")  # Polygon labels in YOLO format

# Output directories for augmented data
OUT_IMG_DIR = os.path.join(DATASET_DIR, "images_aug")  # Augmented images
OUT_LBL_DIR = os.path.join(DATASET_DIR, "labels_aug")  # Augmented polygon labels
...
for img_file in img_files:
    ...
    cv2.imwrite(os.path.join(OUT_IMG_DIR, orig_img_file), image)
    write_polygon_labels(os.path.join(OUT_LBL_DIR, orig_lbl_file), polygons, classes)
    success_count += 1
    ...
    for i in range(N_AUGS):
        ...
        try:
            ...
            if success:
                ...
                write_polygon_labels(os.path.join(OUT_LBL_DIR, out_lbl_file), 
