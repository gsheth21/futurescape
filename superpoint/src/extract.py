...
# YOLO_WEIGHTS = 'saved_models/board_detector_v1.pt'
...
def detect_board(image_path, weights=YOLO_WEIGHTS, conf_thresh=0.5):
    """
...
def crop_board(image_path, weights=YOLO_WEIGHTS, padding=PADDING):
    """
...
def visualize_detection(image_path, weights=YOLO_WEIGHTS, save_path=None):
    """
