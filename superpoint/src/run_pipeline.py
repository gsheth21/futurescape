...
TEMPLATE_DIR  = '../raw_dataset/preprocessed/ideal_templates'
# TEST_IMAGE_DIR = '../raw_dataset/preprocessed/test_images'
# RESULTS_DIR = '../raw_dataset/preprocessed/test_images_results'
TEST_IMAGE_DIR = '../raw_dataset'
RESULTS_DIR = '../raw_dataset'

# Your canonical keypoints defined on the template image (x, y in pixels)
CANONICAL_KPS_PATH   = '../raw_dataset/preprocessed/ideal_templates/ideal_image_gt.npy'
...
if __name__ == '__main__':
    ...
    # 2. Load & detect on template (just the first one)
    ...
    for name, tensor in test_tensors.items():
        ...
        # Optionally visualize matches too
        ...
        draw_keypoints(img_path, projected_kps, save_path=Path(RESULTS_DIR) / f"{name}_pred.png")